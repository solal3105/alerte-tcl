...
l'onglet Stationnement) sur le simulateur iPhone 15 Pro et sur l'émulateur Pixel 8, en mode démo : un bus
...
| `02-carte-velov` | L'onglet Stationnement sur les stations Vélo'v : un carré à la couleur de disponibilité avec le nombre de vélos, la capsule « LIVE ». Mode démo `velov`. |
...
| `06-stationnement-accueil` | L'accueil à tuiles de l'onglet Stationnement. Mode démo `stationnement`. |
