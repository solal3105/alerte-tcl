...
l'onglet Parkings) sur le simulateur iPhone 15 Pro et sur l'émulateur Pixel 8, en mode démo : un bus
...
| `02-carte-velov` | L'onglet Parkings sur le type Vélo'v : un carré à la couleur de disponibilité avec le nombre de vélos, la capsule « LIVE ». Mode démo `velov`. |
