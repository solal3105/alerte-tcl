...
l'onglet Ville) sur le simulateur iPhone 15 Pro et sur l'émulateur Pixel 8, en mode démo : un bus
...
| `02-carte-velov` | L'onglet Ville sur les stations Vélo'v : un carré à la couleur de disponibilité avec le nombre de vélos, la capsule « LIVE ». Mode démo `velov`. |
...
| `06-ville-accueil` | L'accueil à tuiles en verre de l'onglet Ville. Mode démo `ville`. |
