...
| `06-horaires-a-larret` | Les horaires d'une journée à un arrêt : les prochains passages en direct en tête, puis la grille théorique par heure (l'heure à gauche, les minutes à droite), prochain passage mis en avant, passés estompés, choix du jour instantané. Mode démo `horaires-arret`. |
